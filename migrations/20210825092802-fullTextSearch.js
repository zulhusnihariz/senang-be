...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    return Promise.all([
      Object.keys(searchObjects).forEach(async table => {
        await queryInterface.addColumn(`${table}`, `${vectorName}`, Sequelize.TSVECTOR);
      }),
      Object.keys(searchObjects).forEach(
        async table =>
